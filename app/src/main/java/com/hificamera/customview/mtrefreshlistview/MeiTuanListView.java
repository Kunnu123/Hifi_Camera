package com.hificamera.customview.mtrefreshlistview;
	...
	private void changeHeaderByState(int state){
		switch (state) {
			...
			case RELEASE_TO_REFRESH:
				tv_pull_to_refresh.setText("Let go and refresh");
			...
			case PULL_TO_REFRESH:
				tv_pull_to_refresh.setText("Pull down to refresh");
				mFirstView.setVisibility(View.VISIBLE);
				mSecondView.setVisibility(View.GONE);
				secondAnim.stop();
				mThirdView.setVisibility(View.GONE);
				...
				break;
			case REFRESHING:
				tv_pull_to_refresh.setText("Refreshing");
				mFirstView.setVisibility(View.GONE);
