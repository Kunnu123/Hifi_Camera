...
import com.hificamera.thecamhi.adapter.SpAdapter;
...
//    private HiChipDefines.HI_P2P_RESOLUTION video_param_re;
    ...
    private String oldResolution,nowResolution;
    @Override
    ...
    private void setVideoParams(int frame_rate_first, int frame_rate_second, String first_str_level_str, String second_str_level_str) {
        ...
        if(isSuportRes&&isChangeResolution){
            int resolution=0;
            if(spinner.getSelectedItem().toString().equals("2560x1440")){
                resolution=16; //hi_p2P_get_resolution.u32Resolution=16;
            }else {
                resolution=20;//hi_p2P_get_resolution.u32Resolution=20;
            }
            byte[] resolution1 =  HiChipDefines.HI_P2P_RESOLUTION.parseContent(0,1);
            byte[] Resolutio = Packet.intToByteArray_Little(resolution);//hi_p2P_get_resolution.u32Resolution
                        ...
                        switch (msg.arg1) {
                            ...
                            case HiChipDefines.HI_P2P_GET_VIDEO_PARAM:
                                ...
                                if (video_param.u32Stream == HiChipDefines.HI_P2P_STREAM_1) {
                                   ...
                                   HiLog.e( video_param_hd.u32BitRate + "==" + video_param_hd.u32Frame + "==" + video_param_hd.u32Quality);
                                   ...
                                   HiLog.e( video_param_sd.u32BitRate + "==" + video_param_sd.u32Frame + "==" + video_param_sd.u32Quality);
                            ...
                            case HiChipDefines.HI_P2P_SET_VIDEO_PARAM:
                                ...
                                if (count == 2) {
                                    ...
                                    count = 0;
                                   HiLog.e("isChange="+isChangeResolution+"  isIngenic="+mCamera.isIngenic);
                                    if(isChangeResolution&&mCamera.isIngenic){
                                        startActivity(new Intent(VideoSettingActivity.this, MainActivity.class));
                                        finish();
                                    }
                            ...
                            case HiChipDefines.HI_P2P_GET_RESOLUTION:
                               ...
                               HiLog.e("ss="+hi_p2P_get_resolution.u32Resolution);
                                if (hi_p2P_get_resolution.u32Resolution == 16) {
                                ...
                                break;
                            case HiChipDefines.HI_P2P_GET_VIDEO_IMAGE_PARAM_SCOPE: {
