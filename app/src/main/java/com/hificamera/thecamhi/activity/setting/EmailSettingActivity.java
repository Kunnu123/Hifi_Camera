...
import com.hificamera.thecamhi.utils.SpcialCharFilterEmailFTP;
...
public class EmailSettingActivity extends HiActivity implements ICameraIOSessionCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (MyCamera camera : HiDataValue.CameraList) {
            if (uid.equals(camera.getUid())) {
               ...
               HiLog.e("isSupportLenExt"+isSupportLenExt);
               HiLog.e( "isSupportFullChar=" + isSupportFullChar);
               HiLog.e( "isSupportParamExt=" + isSupportParamExt);
               HiLog.e( "isSupportNew=" + isSupportNewGet);
               HiLog.e( "isSupportNoFullNewGet=" + isSupportNoFullNewGet);
                if (isSupportNewGet) {
    ...
    protected void sendMailSetting(boolean check) {
       ...
       HiLog.e( (themeStr == null) + "---" + themeStr.isEmpty());
        if (themeStr == null || themeStr.isEmpty()) {
            themeStr = "\u00a0";
        }
       HiLog.e( themeStr.length() + "");
                            ...
                            case HiChipDefines.HI_P2P_GET_EMAIL_PARAM:
                                ...
                                if (isSupportNoFullNewGet) {
                                    ...
                                    for (int i = 0; i < param.strTo.length; i++) {
                                        ...
                                        stringBuffer.append(";");
                                       HiLog.e( "sss=" + new String(param.strTo[i]).trim());
                                    }
                                   HiLog.e("sssbuff=" + stringBuffer.toString());
                                    if (";;;".equals(stringBuffer.toString().trim())) {
                                        ...
                                        } else if (stringBuffer.toString().trim().endsWith(";;")) {
                                   ...
                                   HiLog.e( "sss=" + new String(param.strTo[0]).trim());
                               ...
                               HiLog.e( (sub == null) + sub + "  lenth===" + sub.length());
                            ...
                            case HiChipDefines.HI_P2P_GET_EMAIL_PARAM_NEWPWD255_EXT:
                                ...
                                if (isSupportNewGet) {
                                    ...
                                    for (int i = 0; i < param_ext.strTo.length; i++) {
                                       ...
                                       HiLog.e( "sss=" + new String(param_ext.strTo[i]).trim());
                                    }
                                   HiLog.e( "sssbuff=" + stringBuffer1.toString());
                                    if (";;;".equals(stringBuffer1.toString().trim())) {
                                        ...
                                        } else if (stringBuffer1.toString().trim().endsWith(";;")) {
                                   ...
                                   HiLog.e("sss=" + new String(param_ext.strTo[0]).trim());
