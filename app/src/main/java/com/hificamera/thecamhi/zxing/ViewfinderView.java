...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        laserColor_left = resources.getColor(R.color.viewfinder_laser_left);
        laserColor_center = resources.getColor(R.color.viewfinder_laser_center);
        laserColor_right = resources.getColor(R.color.viewfinder_laser_right);
        ...
        textColor = resources.getColor(R.color.viewfinder_text);
        resultPointColor = resources.getColor(R.color.possible_result_points);
        rectCorner_color = resources.getColor(R.color.viewfinder_4_corner);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            int pxValue = (int) getResources().getDimension(R.dimen.laser_bottom_text_sp);
