...
import com.hificamera.customview.mtrefreshlistview.MeiTuanListView;
import com.hificamera.R;
import com.hichip.callback.ICameraIOSessionCallback;
import com.hichip.content.HiChipDefines;
import com.hichip.content.HiChipDefines.HI_P2P_FILE_INFO;
import com.hichip.control.HiCamera;
import com.hificamera.thecamhi.activity.PlaybackOnlineActivity;
...
import com.hificamera.thecamhi.bean.RFAlarmEvtent;
...
public class RFAlarmlog extends HiActivity implements ICameraIOSessionCallback, OnClickListener {
	...
	private void setListerners() {
		...
		mLvAlarmlog.setOnMeiTuanRefreshListener(new MeiTuanListView.OnMeiTuanRefreshListener() {
	...
	private void handlerAllAlarmLog(byte[] data) {
		...
		if (TextUtils.isEmpty(string)) {
			if (mFlag == 2) {
				HiToast.showToast(RFAlarmlog.this, "No new data found！");
	...
	private void handData(final String[] strings) {
		for (String str : strings) {
			if (!TextUtils.isEmpty(str)) {
				...
				if (!TextUtils.isEmpty(strs[1]) && !TextUtils.isEmpty(strs[2])) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			switch (evtent.getTypeNum()) {
				...
				case 3:
					...
					break;
				case 4:
					holder.tvCode.setText("Temperature alarm");
					break;
				case 5:
					holder.tvCode.setText("Humidity alarm");
					break;
				case 6:
