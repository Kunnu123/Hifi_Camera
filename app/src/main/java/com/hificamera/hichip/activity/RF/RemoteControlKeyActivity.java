...
public class RemoteControlKeyActivity extends HiActivity implements ICameraIOSessionCallback, OnCheckedChangeListener {
	...
	private void showClosePup() {
		...
		dialog.withTitle("Confirm to close?").withMessage("After closing, the added alarm switch button operation will be invalid!").withButton1Text("Confirm").withButton2Text("Don't close").setButton1Click(new OnClickListener() {
			@Override
	...
	private void initView() {
		...
		mTitleView.setTitle("Button control");
					...
					if (msg.arg2 == 0) {
						...
						switch (msg.arg1) {
							case HiChipDefines.HI_P2P_IPCRF_SINGLE_INFO_SET:
								dismissjuHuaDialog();
								HiToast.showToast(RemoteControlKeyActivity.this, "Successfully modified");
								break;
